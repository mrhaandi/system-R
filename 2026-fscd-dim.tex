...
Overall, the space required by the alternating decision procedure is polynomial in ${(N+1)}^{k}$, yielding an \textsf{AEXPSPACE}, or equivalently \textsf{2-EXPTIME}, decision procedure.
\end{proof}
