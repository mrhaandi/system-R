...
We extend the relation $\rbar{\subseteq}$ to environments of the same dimension so that $\Gamma \rbar{\subseteq} \Delta$ when for each $x \in \dom(\Gamma)$ we have $\Gamma(x) \rbar{\subseteq} \Delta(x)$. We define $\Gamma_1\cup\Gamma_2$ to be the environment $\Delta$ the domain of which is $\dom(\Gamma_1)\cup\dom(\Gamma_2)$ such that for $x\in\dom(\Gamma_i)-\dom(\Gamma_{3-i})$
...
such that $(j,i)\in R$. In case a relation $R$ is right-unique we have $R(\bar{B}) = (\{A_1\},\ldots, \{A_m\})$, thus we can define a vector $R(\bar{B})\!\downarrow\, = (A_1,\ldots,A_m)$.
