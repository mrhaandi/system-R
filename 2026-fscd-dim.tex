...
\begin{enumerate}
    \item\label{prop:rel-properties:monotone} For two binary relations $R, R' \subseteq \{1, \ldots, n\} \times \{1, \ldots, m\}$ we have that if $R \subseteq R'$, then for all $\bar{\sigma}$ such that $\dim(\bar{\sigma}) = n$ we have $R(\bar{\sigma}) \rbar{\subseteq} R'(\bar{\sigma})$.
...
\begin{proof}
    ...
    \begin{itemize}
        ...
        %
        \item Due to $R'(\bar{\sigma}) \subseteq R(\bar{A})$ and since $R'$ is left-total and $\bar{A}$ has unique coordinates, by Lemma~\ref{lem:rel-properties}(\ref{prop:rel-properties:exact}) there exists a $R''$ such that $R'\circ R''\subseteq R$ and $R''(\bar{A}) = \bar{\sigma}$.
